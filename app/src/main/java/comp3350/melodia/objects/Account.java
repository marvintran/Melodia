...
public class Account{
	...
	public Account(String fullName, String userName, String email, String profile, String[] favoriteList){
	...
	public void setFavorList(String[] newList){
