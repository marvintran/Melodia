...
CREATE MEMORY TABLE PUBLIC.SONG(SONGNAME VARCHAR(20), SONGTIME INTEGER NOT NULL, ARTISTNAME VARCHAR(20) NOT NULL, ALBUMNAME VARCHAR(20) NOT NULL, TRACKNUMBER INTEGER NOT NULL, SONGPATH VARCHAR(20))
